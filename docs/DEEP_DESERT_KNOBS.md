...
- Community extracts mention Deep Desert spice-field limits of `Small=60`, `Medium=12`, and `Large=1`, but these limits are not yet exposed in this repository's checked-in INI files.
