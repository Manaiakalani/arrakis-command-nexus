...
class EconomyService:
    ...
    async def _check_solari_threshold(self):
    ...
    async def _check_base_claims(self):
    ...
    def add_alert(self, alert_type: str, severity: str, message: str, details: dict | None = None):
