...
class CharacterService:
    ...
    KNOWN_TEMPLATES: dict[str, tuple[str, str]] = {
        ...
        "T1ExplorationComponent": ("Components", "Exploration Component (T1)"),
        ...
        "BladeParts": ("Components", "Blade Parts"),
        "GunParts": ("Components", "Gun Parts"),
        "ComplexMachinery": ("Components", "Complex Machinery"),
        "AdvancedMachinery": ("Components", "Advanced Machinery"),
        "CalibratedServok": ("Components", "Calibrated Servok"),
        "HoltzmanActuator": ("Components", "Holtzman Actuator"),
        "EMFGenerator": ("Components", "EMF Generator"),
        "IndustrialPump": ("Components", "Industrial Pump"),
        "HeavyCaliberCompressor": ("Components", "Heavy Caliber Compressor"),
        "LightCaliberCompressor": ("Components", "Light Caliber Compressor"),
        "MilitaryPowerRegulator": ("Components", "Military Power Regulator"),
        "HydraulicPiston": ("Components", "Hydraulic Piston"),
        "ArmorPlating": ("Components", "Armor Plating"),
        "InsulatedFabric": ("Components", "Insulated Fabric"),
        "MicroSandwichFabric": ("Components", "Micro-Sandwich Fabric"),
        "BallisticWeaveFabric": ("Components", "Ballistic Weave Fabric"),
        "AtmosphericFilteredFabric": ("Components", "Atmospheric Filtered Fabric"),
        "FlutedHeavyCaliberCompressor": ("Components", "Fluted Heavy Caliber Compressor"),
        "FlutedLightCaliberCompressor": ("Components", "Fluted Light Caliber Compressor"),
        "FluidEfficientIndustrialPump": ("Components", "Fluid Efficient Industrial Pump"),
        "ImprovedHoltzmanActuator": ("Components", "Improved Holtzman Actuator"),
        "ImprovedWatertube": ("Components", "Improved Watertube"),
        "IrradiatedCore": ("Components", "Irradiated Core"),
        "ParticleCapacitor": ("Components", "Particle Capacitor"),
        "RangeFinder": ("Components", "Range Finder"),
        "RayAmplifier": ("Components", "Ray Amplifier"),
        "CarbideBladeParts": ("Components", "Carbide Blade Parts"),
        "DiamodineBladeParts": ("Components", "Diamodine Blade Parts"),
        "PlasteelPlate": ("Components", "Plasteel Plate"),
        # Consumables
