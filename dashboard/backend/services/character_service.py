...
class CharacterService:
    ...
    KNOWN_TEMPLATES: dict[str, tuple[str, str]] = {
        ...
        "HarkAr7": ("Weapons", "Harkonnen Assault Rifle Mk7"),
        "AtreLMG5": ("Weapons", "Atreides LMG Mk5"),
        "CHOAMSword_3": ("Weapons", "Regis Sword (CHOAM)"),
        "RocketLauncher_2": ("Weapons", "Rocket Launcher Mk2"),
        "SmugDmr4": ("Weapons", "Smuggler DMR Mk4"),
        "SmugDmr5": ("Weapons", "Smuggler DMR Mk5"),
        "HoltzmanShieldActiveDrain3": ("Tools", "Holtzman Shield Mk5"),
        "Radiation_Suit_T5": ("Tools", "Radiation Suit Mk5"),
        "Bloodsack_Unique_Durable_04": ("Consumables", "Durable Blood Sack Mk4"),
        "Combat_Choam_Light05_Gloves": ("Armor", "CHOAM Light Gloves Mk5"),
        "Combat_Choam_Light05_Boots": ("Armor", "CHOAM Light Boots Mk5"),
        "Combat_Choam_Light06_Helmet": ("Armor", "CHOAM Light Helmet Mk6"),
        "Combat_Choam_Light06_Top": ("Armor", "CHOAM Light Chest Mk6"),
        "Combat_Choam_Light06_Bottom": ("Armor", "CHOAM Light Legs Mk6"),
        "Combat_Choam_Light06_Gloves": ("Armor", "CHOAM Light Gloves Mk6"),
