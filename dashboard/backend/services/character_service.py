...
class CharacterService:
    ...
    KNOWN_TEMPLATES: dict[str, tuple[str, str]] = {
        ...
        # Vehicle Parts (PascalCase - real Unreal ids per awakening.wiki)
        ...
        # Legacy/recipe-style sandbike entries (kept for back-compat)
        "T2_Vehicle_Ground__SandBikeBodyHull": ("Vehicle Parts", "Sandbike Body Hull (recipe)"),
        "T2_Vehicle_Ground__SandBikeChassis": ("Vehicle Parts", "Sandbike Chassis (recipe)"),
        "T2_SandbikeEngine": ("Vehicle Parts", "Sandbike Engine (recipe)"),
        "T2_Vehicle_Ground__SandBikeTreads": ("Vehicle Parts", "Sandbike Treads (recipe)"),
        "T2_Vehicle_Ground__SandBikeInventoryModule": ("Vehicle Parts", "Sandbike Inventory Module (recipe)"),
