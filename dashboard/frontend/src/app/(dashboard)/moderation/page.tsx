      ...
      <div className="glass-panel overflow-hidden">
        <div className="flex flex-col gap-3 border-b border-th-border-m/80 p-5 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h2 className="mt-1 inline-flex items-center gap-2 text-xl font-semibold text-th-text"><ShieldAlert className="h-5 w-5 text-amber-600 dark:text-amber-300" /> Recent Violations</h2>
          </div>
          <button type="button" className="dune-button-muted" onClick={() => void handleClear()}>
            <Trash2 aria-hidden="true" className="mr-2 h-4 w-4" /> Clear violations
          </button>
        </div>
        ...
        {(violations.data ?? []).length === 0 ? (
          <div className="flex min-h-[280px] flex-col items-center justify-center gap-4 p-8 text-center">
            <ShieldAlert aria-hidden="true" className="h-10 w-10 text-emerald-700 dark:text-emerald-300" />
            <div>
