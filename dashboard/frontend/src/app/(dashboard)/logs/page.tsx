    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <h2 className="mt-1 text-xl font-semibold text-th-text">Service Logs</h2>
        </div>
        <div className="flex flex-wrap items-center gap-3">
          ...
          <a href={`/api/logs/download${service !== 'all' ? `?service=${encodeURIComponent(service)}` : ''}`} download className="dune-button-muted">
