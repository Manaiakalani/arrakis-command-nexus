    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <h2 className="mt-1 text-2xl font-semibold text-th-text">Discord notifications</h2>
        </div>
      </div>
      ...
      <div className="glass-panel overflow-hidden">
        <div className="border-b border-th-border-m/80 p-5">
          ...
          <h2 className="mt-1 inline-flex items-center gap-2 text-xl font-semibold text-th-text"><Bell aria-hidden="true" className="h-5 w-5 text-amber-600 dark:text-amber-300" /> Last 10 Notifications</h2>
        </div>
