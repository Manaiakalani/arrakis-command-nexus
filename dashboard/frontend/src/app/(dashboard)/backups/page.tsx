  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-5">
        ...
        <h2 className="mt-1 inline-flex items-center gap-2 text-xl font-semibold text-th-text"><HardDrive aria-hidden="true" className="h-5 w-5 text-amber-600 dark:text-amber-300" /> Recovery footprint</h2>
      ...
      <div className="glass-panel p-5">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <h2 className="mt-1 inline-flex items-center gap-2 text-xl font-semibold text-th-text"><Database aria-hidden="true" className="h-5 w-5 text-amber-600 dark:text-amber-300" /> Automated backups</h2>
          ...
          >
            <Database aria-hidden="true" className="mr-2 h-4 w-4" /> {schedule.enabled ? 'Disable scheduling' : 'Enable scheduling'}
          </button>
        </div>
        ...
        <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          >
            <Save aria-hidden="true" className="mr-2 h-4 w-4" /> {savingSchedule ? 'Saving…' : 'Save schedule'}
          </button>
        </div>
      </div>
      <BackupList
