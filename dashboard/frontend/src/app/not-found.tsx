  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-dune-radial">
      <div className="text-center">
        ...
        <h1 className="mt-4 text-2xl font-semibold text-th-text">Lost in the Deep Desert</h1>
        <p className="mt-2 text-sm text-th-text-m">This page could not be found in Arrakis.</p>
